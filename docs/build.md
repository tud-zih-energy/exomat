...
$ ./package_exomat deb $HOME/exomat/target/release
...
$ ./package_exomat rpm $HOME/exomat/target/aarch64-unknown-linux-musl/release
...
- remove the need to edit the cargo config (step 1)
